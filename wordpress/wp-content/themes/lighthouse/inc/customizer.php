...
function lighthouse_customize_register( $wp_customize ) {
 ...
 $wp_customize->remove_control('display_header_text');
	...
	$wp_customize->add_section(
		...
		array(
			'title' => __('Lighthouse Premium Version', 'lighthouse'),
			'priority' => 0,
			'description' => __(' ', 'lighthouse') . '<a href="https://outstandingthemes.com/themes/lighthouse/" target="_blank"><img src="' . get_template_directory_uri() . '/images/small-theme.png"></a>',
			)
		); 
